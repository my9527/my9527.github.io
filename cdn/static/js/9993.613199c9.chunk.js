...
`,S=R.default.div.withConfig({displayName:"AirdropModal__Line",componentId:"sc-abdf66e8-3"})`
  ...
  margin-top: 12px;
  margin-bottom: 12px;
`,M=R.default.a.withConfig({displayName:"AirdropModal__LinkWrap",componentId:"sc-abdf66e8-4"})`
  text-decoration: none;
  ${_.c}
`,O=R.default.div.withConfig({displayName:"AirdropModal__ImageContainer",componentId:"sc-abdf66e8-5"})`
  position: relative;
  width: 100%;
`,v=R.default.img.withConfig({displayName:"AirdropModal__StyledImage",componentId:"sc-abdf66e8-6"})`
  width: 100%;
  height: 170px;
`,j=R.default.div.withConfig({displayName:"AirdropModal__USDCLabel",componentId:"sc-abdf66e8-7"})`
  font-weight: 700;
  font-size: 36px;
  line-height: 44px;
  margin-top: 8px;
  color: white;
`,k=R.default.div.withConfig({displayName:"AirdropModal__TextContainer",componentId:"sc-abdf66e8-8"})`
  position: absolute;
  left: 16px;
  top: 16px;
  right: 16px;
`,D=R.default.div.withConfig({displayName:"AirdropModal__RewardsDetailsContainer",componentId:"sc-abdf66e8-9"})`
  display: flex;
  width: 100%;
  justify-content: space-between;
`,L=R.default.span.withConfig({displayName:"AirdropModal__CurrencyText",componentId:"sc-abdf66e8-10"})`
  color: white;
  font-weight: 500;
  font-size: 12px;
  line-height: 14.5px;
`,U=R.default.div.withConfig({displayName:"AirdropModal__ClaimContainer",componentId:"sc-abdf66e8-11"})`
  display: flex;
  flex-direction: column;
  text-align: center;
  height: 380px;
  padding: 60px 28px;
  padding-bottom: 20px;
`,W=R.default.div.withConfig({displayName:"AirdropModal__SuccessText",componentId:"sc-abdf66e8-12"})`
  font-weight: 400;
  font-size: 16px;
  line-height: 24px;
  margin-top: 24px;
  margin-bottom: 8px;
`,F=R.default.a.withConfig({displayName:"AirdropModal__EtherscanLink",componentId:"sc-abdf66e8-13"})`
  text-decoration: none;

  ${_.c}
`,B=(0,R.default)(m.UH).withConfig({displayName:"AirdropModal__CloseButton",componentId:"sc-abdf66e8-14"})`
  max-width: 68px;
  margin-top: auto;
  margin-left: auto;
  margin-right: auto;
`,G=(0,R.default)(b.Tw).withConfig({displayName:"AirdropModal__SyledCloseIcon",componentId:"sc-abdf66e8-15"})`
  float: right;
  height: 24px;

  ${_.c}
`,$=R.default.div.withConfig({displayName:"AirdropModal__Error",componentId:"sc-abdf66e8-16"})`
  display: flex;
  ...
  align-items: center;
  gap: 12px;
`,Y=R.default.div.withConfig({displayName:"AirdropModal__ReactLinkWrap",componentId:"sc-abdf66e8-17"})`
  margin-bottom: 40px;
`,H=R.default.span.withConfig({displayName:"AirdropModal__RewardsText",componentId:"sc-abdf66e8-18"})`
  font-size: 12px;
  line-height: 16px;
  color: ${({theme:e})=>e.white};
